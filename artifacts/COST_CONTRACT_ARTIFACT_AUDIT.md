...
| Evaluation and governance | 22/22 automated checks pass, including deliberate ledger corruption, multi-format eligibility, workflow-step guidance, model-tier switching, and GOV-009 propagation; GOV-015 discloses heuristic evidence. | Verified locally |
...
- 22 automated application checks pass.
