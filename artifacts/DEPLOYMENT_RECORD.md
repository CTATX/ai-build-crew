...
|---|---|
| Rollback release | `v0.2.0-rc.7` at `068c55fa2ccf75483d43c4932fba20f8ebf155c3` |
| Original baseline | `alpha-baseline-2026-08-08` at `cd7a8282a6964a049221e31c9682f8dd694d7efe` |
| Release source | Immutable tag `v0.2.0-rc.8` on `main` |
