...
|---|---|
| Rollback release | `v0.3.0-rc.1` at `65ac7622170e14bd9fc209a2ee53a9781dab7865` |
| Original baseline | `alpha-baseline-2026-08-08` at `cd7a8282a6964a049221e31c9682f8dd694d7efe` |
| Release source | Immutable tag `v0.3.0-rc.2` on `main` |
...
| Local release gates | 36/36 tests, build, lint, persona-guided desktop/mobile QA, structured-result contract, owner authorization, and spend controls pass |
