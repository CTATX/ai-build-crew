...
|---|---|
| Rollback release | `v0.2.0-rc.4` at `a2edc42ceafe5739b272064d800460117f6f10c7` |
| Original baseline | `alpha-baseline-2026-08-08` at `cd7a8282a6964a049221e31c9682f8dd694d7efe` |
| Release source | Immutable tag `v0.2.0-rc.5` on `main` |
